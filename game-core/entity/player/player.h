...
public:
  ...
  Player() {}
  Player(int *renderIndex, glm::vec3 position = glm::vec3(0.0f),
         glm::vec2 size = glm::vec2(10.0f), glm::vec4 color = glm::vec4(1.0f),
         glm::vec2 possOfsetRect = glm::vec2(0.0f),
  ...
  void m_processInput(bool keys[1024], bool keysProcessed[1024], float &dt);
